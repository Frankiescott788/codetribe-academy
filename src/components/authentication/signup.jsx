...
import { Card, Button, Input, Breadcrumbs } from "@nextui-org/react";
...
const Signup = () => {
    ...
    const { setEmail, setPassword, setUsername, sign_up } = useAuth();
  return (
    <main>
      <section>
        <div>
        ...
        <div className="mx-5 flex justify-between">
          <div className="ps-[15dvw] pt-[15dvh]">
            <Card className="w-[25rem] p-5 shadow-none border-1">
              <Input
                type="text"
